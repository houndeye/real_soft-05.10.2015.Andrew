(function (root, factory) {
    ...
    var ReactSlider = React.createClass({
        ...
        propTypes: {
            ...
            disabledSliderClick: React.PropTypes.bool,
            disabledMouseDown: React.PropTypes.bool,
            /**
        ...
        getDefaultProps: function () {
            return {
                ...
                pearling: false,
                disabled: false,
                disabledSliderClick: false,
                disabledMouseDown: false,
        ...
        _onSliderMouseDown: function (e) {
            if (this.props.disabled) return;
            if (this.props.disabledMouseDown) return;
            this.hasMoved = false;
        ...
        _onSliderClick: function (e) {
            ...
            //if (this.props.disabledSliderClick) return;
