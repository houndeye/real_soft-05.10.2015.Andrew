...
export default React.createClass({
    ...
    render: function () {
        var Panels = this.props.client.length > 1 ? this.props.client.map(function (prop, i) {
            return (
                <Panel key={i} style={this.props.Style.bg}
                    ...
                    <PanelContent data={prop} dataObj={this.props.data[i]} labels={this.props.labels}
                                ...
                                bsSize={this.props.bsSize}
                                eventKey={1}>
            <PanelContent data={this.props.client[0]} dataObj={this.props.data[0]}
...
var PanelContent = React.createClass({
    onClick1(){
        this.props.click[0](this.props.data, this.props.dataObj);
    },
    onClick2(){
